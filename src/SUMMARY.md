...
- [Usando Structs para Estruturar Dados Relacionados](ch05-00-structs.md)
  ...
  - [Um Exemplo de Programa Usando Structs](ch05-02-example-structs.md)
  - [Métodos](ch05-03-method-syntax.md)

- [Enums e Correspondência de Padrões (Pattern Matching)](ch06-00-enums.md)
  - [Definindo um Enum](ch06-01-defining-an-enum.md)
  - [A Construção de Controle de Fluxo `match`](ch06-02-match.md)
  - [Controle de Fluxo Conciso com `if let` e `let...else`](ch06-03-if-let.md)
...
- [Pacotes, Crates e Módulos](ch07-00-managing-growing-projects-with-packages-crates-and-modules.md)
  ...
  - [Controlando o Escopo e a Privacidade com Módulos](ch07-02-defining-modules-to-control-scope-and-privacy.md)
...
- [Tratamento de Erros](ch09-00-error-handling.md)
  - [Erros Recuperáveis com `panic!`](ch09-01-unrecoverable-errors-with-panic.md)
  - [Erros Recuperáveis com `Result`](ch09-02-recoverable-errors-with-result.md)
  - [Para `panic!` ou Não para `panic!`](ch09-03-to-panic-or-not-to-panic.md)

- [Tipos Genéricos, Traits e Tempos de Vida (Lifetimes)](ch10-00-generics.md)
...
- [Um Projeto de E/S: Construindo um Programa de Linha de Comando](ch12-00-an-io-project.md)
  ...
  - [Adicionando Funcionalidades com Desenvolvimento Orientado a Testes (TDD)](ch12-04-testing-the-librarys-functionality.md)
...
- [Recursos de Linguagem Funcional: Iteradores e Closures](ch13-00-functional-features.md)
  ...
  - [Processando Séries de Itens com Iteradores](ch13-02-iterators.md)
  - [Melhorando Nosso Projeto de E/S](ch13-03-improving-our-io-project.md)
  - [Desempenho em Laços vs. Iteradores](ch13-04-performance.md)

- [Mais sobre o Cargo e o Crates.io](ch14-00-more-about-cargo.md)
  - [Personalizando Compilações com Perfis de Lançamento](ch14-01-release-profiles.md)
...
- [Ponteiros Inteligentes](ch15-00-smart-pointers.md)
  ...
  - [Tratando Ponteiros Inteligentes como Referências Comuns](ch15-02-deref.md)
  - [Executando Código na Limpeza com a Trait `Drop`](ch15-03-drop.md)
  ...
  - [Ciclos de Referência Podem Vazamento de Memória](ch15-06-reference-cycles.md)
...
- [Fundamentos da Programação Assíncrona: Async, Await, Futures e Streams](ch17-00-async-await.md)
  ...
  - [Trabalhando com Qualquer Quantidade de Futures](ch17-03-more-futures.md)
  - [Streams: Futures em Sequência](ch17-04-streams.md)
  - [Um Olhar Mais Atento sobre as Traits para Async](ch17-05-traits-for-async.md)
...
- [Recursos de Programação Orientada a Objetos](ch18-00-oop.md)
  ...
  - [Usando Objetos Trait para Abstrair sobre Comportamento Compartilhado](ch18-02-trait-objects.md)
  - [Implementando um Padrão de Design Orientado a Objetos](ch18-03-oo-design-patterns.md)

- [Padrões e Correspondência](ch19-00-patterns.md)
  - [Todos os Lugares Onde Padrões Podem Ser Usados](ch19-01-all-the-places-for-patterns.md)
  - [Refutabilidade: Se um Padrão Pode Falhar ao Corresponder](ch19-02-refutability.md)
  - [Sintaxe de Padrões](ch19-03-pattern-syntax.md)

- [Recursos Avançados](ch20-00-advanced-features.md)
  - [Rust Inseguro (Unsafe Rust)](ch20-01-unsafe-rust.md)
...
- [Projeto Final: Construindo um Servidor Web Multithread](ch21-00-final-project-a-web-server.md)
  - [Construindo um Servidor Web de uma Única Thread](ch21-01-single-threaded.md)
  - [De Servidor de Uma Única Thread para Multithread](ch21-02-multithreaded.md)
  - [Encerramento Gracioso e Limpeza](ch21-03-graceful-shutdown-and-cleanup.md)
...
- [Apêndice](appendix-00.md)
  ...
  - [G - Como o Rust é Feito e o “Nightly Rust”](appendix-07-nightly-rust.md)